...
3. If dates are open-ended ('until further notice'), output 'UNTIL FURTHER NOTICE'. Never hallucinate dates.
"""
...
async def extract_bulletin(req: BulletinExtractRequest):
    ...
    try:
        ...
        try:
            ...
            # Find matching trail in PostGIS (handles both Route Numbers & Trail Names)
            cur.execute(
            ...
            # Deactivate legacy alerts for this specific trail so the new extraction takes immediate precedence
